<script context="module">
  ...
  function getLocation() {
    ...
    return { location: url.pathname, search: url.search };
  }
  ...
  export function push(location) {
    ...
    return tick().then(() => {
      ...
      // Somehow popState is not pushed
  ...
  function updateLink(node, href) {
    ...
    node.addEventListener("click", (event) => handleMouseClick(event, href));
  }

  function handleMouseClick(event, hrefVar) {
